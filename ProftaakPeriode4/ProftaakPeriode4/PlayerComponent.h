...
public:
	...
	*/
	explicit PlayerComponent(int laneIndex, int laneCount, LifeBar * lifeBar, Image * gameOverScreen, Text * powerUp ,Model * model, Sound * coinSound, Sound * collisionSound, Sound * deathSound, bool useOpenCV = true);
	/**
